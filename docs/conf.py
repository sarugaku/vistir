...
htmlhelp_basename = 'vistirdoc'
extlinks = {
    'issue': ('https://github.com/sarugaku/vistir/issues/%s', '#'),
    'pull': ('https://github.com/sarugaku/vistir/pull/%s', 'PR #'),
}
html_theme_options = {
...
latex_documents = [
    (master_doc, 'vistir.tex', 'vistir Documentation',
